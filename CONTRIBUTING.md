...
functionality you're adding in your contribution. Check out the [tests](https://github.com/terra-farm/terraform-aws-honeycomb/tree/master/test) 
folder for instructions on running the automated tests. 
